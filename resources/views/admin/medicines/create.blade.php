    ...
    <div class="container">
        <form action="{{route('medicines.store')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('brand') is-invalid @enderror" id="brand" name="brand" placeholder="">
                @error('brand')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('type') is-invalid @enderror" id="type" name="type" placeholder="">
                @error('type')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input name="price" id="price" type="number" min="100" step="50" class="form-control @error('price') is-invalid @enderror" value="">
                </div>
                @error('price')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
