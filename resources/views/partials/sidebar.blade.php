                ...
                <div class="main-nav d-none d-lg-block">
                    <nav class="site-navigation text-right text-md-center" role="navigation">
                        ...
                        @guest
                            {{-- <ul class="navbar-nav"> --}}
                                <li class="nav-item">
                                    <a class="nav-link btn btn-outline-success my-2 my-sm-0" href="{{ route('register') }}">Register</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link btn btn-outline-success my-2 my-sm-0" href="{{ route('login') }}">Login</a>
                                </li>
